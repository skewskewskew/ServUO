...
{
    public class ClumsierSpell : MagerySpell
    {
        private static readonly SpellInfo m_Info = new SpellInfo(
            ...
            Reagent.Bloodmoss,
            Reagent.Nightshade);
        public ClumsierSpell(Mobile caster, Item scroll)
        ...
        {
            private readonly ClumsierSpell m_Owner;
            public InternalTarget(ClumsierSpell owner)
